...
//Tested with IBM UrbanCode Deploy 6.2.1.0
//Command line usage:
//groovy -cp udclient.jar ListComponentsWithSize.groovy https://hostname:8443 username password
	...
	if (components){
		...
		if(versions){
			versions.each{
				...
				println "  Version Size = "+it.sizeOnDisk;
				println "  Archived = "+it.archived;
